...
if len(sys.argv) != 3:
    raise SystemExit("usage: GENERATE_VMFL003_20D_5SLABS_PER_D.py source20D.msh output20D.msh")
...
print("AXIAL_20D_5SLABS_PER_D")
print(f"  D                         = {D:.16e}")
print(f"  L                         = {L:.16e}")
print(f"  slabs_per_D               = 5")
...
print("VMFL003_20D_5SLABS_PER_D_MESH_GENERATION=PASS")
