...
OUTROOT="${OUTROOT:-$HOME/Desktop/meshes/nodals_vmfl003_20D_hybrid4x_575k}"
MSH_OUT="${MSH_OUT:-$OUTROOT/VMFL003_20D_HYBRID4X.msh}"
...
echo "=== BUILD VMFL003 20D HYBRID4X ==="
echo "sourceMsh=$SRC"
echo "outputRoot=$OUTROOT"
echo "policy=0-10D:D/18_identical 10-20D:2D/9_4x_axial"

python3 "$HERE/GENERATE_VMFL003_20D_HYBRID4X.py" "$SRC" "$MSH_OUT" | tee "$OUTROOT/generate.log"
...
printf 'NODALS_VMFL003_20D_HYBRID4X_BUILD mesh=%s source=%s expectedSlabs=225 expectedTets=575100 first10D_dzOverD=0.055555555556 second10D_dzOverD=0.222222222222 status=PASS\n' \
