...
if len(sys.argv) != 3:
    raise SystemExit("usage: GENERATE_VMFL003_20D_HYBRID4X.py source20D.msh output20D_hybrid4x.msh")
...
#   10-20D : quadruple original axial spacing, dz = 4*dz0 = 2D/9 -> 45 slabs
N_FINE = 180
N_LONG = 45
spacings = [dz0] * N_FINE + [4.0 * dz0] * N_LONG
nslab = len(spacings)

if nslab != 225:
    raise RuntimeError(f"Expected 225 slabs, got {nslab}")
...
print(f"  second10D_dz_over_D       = {4.0*dz0/D:.12e}")
print(f"  aspect_ratio_multiplier   = 4.0")
...
print("VMFL003_20D_HYBRID4X_MESH_GENERATION=PASS")
