...
TAG="VMFL003_10D_GATE3_WALL_${PREC^^}"
LOG="$HERE/${TAG}.log"
...
echo
echo "=== GATE3 SUMMARY ==="
grep -E 'NODALS_GPU_RANS_GATE1|NODALS_GPU_RANS_GATE2|NODALS_GPU_RANS_GATE3|NODALS_GPU_H8_SETUP|NODALS_GPU_H8_SIMPLE|NODALS_GPU_H8_FIXED10|NODALS_GPU_H8_RESIDENCY|NODALS_GPU_RESULT' "$LOG" || true
